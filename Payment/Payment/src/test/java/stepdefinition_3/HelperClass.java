...
public class HelperClass {
	...
	public static void precondition() {
		...
		PageFactory.initElements(driver,Payment_Repository_3.class);
	...
	public static void login() {
		...
		wait.until(ExpectedConditions.visibilityOf(Payment_Repository_3.username));
		Payment_Repository_3.username.sendKeys(userName);
		Payment_Repository_3.username.sendKeys(Keys.ENTER);
		Payment_Repository_3.password.sendKeys(password);
		Payment_Repository_3.submit_Bt.click();
