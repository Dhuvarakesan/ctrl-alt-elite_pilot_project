...
public class AccountInfoStepDef {
    ...
    public void select_the_pickfromyourcontactlist_on_book_icon() throws InterruptedException {
        PageFactory.initElements(driver, Repository_2.class);
        WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(ExpectedConditions.visibilityOf(Repository_2.userTOSearch));
        Thread.sleep(3000);
        Repository_2.userTOSearch.click();
    }
    ...
    public void click_on_the_period_menu() throws InterruptedException {
        PageFactory.initElements(driver, Repository_2.class);
        WebDriverWait wait = new WebDriverWait(driver, 10);
    ...
    public void click_the_filter_option() throws InterruptedException {
        PageFactory.initElements(driver, Repository_2.class);
        WebDriverWait wait = new WebDriverWait(driver, 10);
    ...
    public void click_the_direction_option() throws InterruptedException {
        PageFactory.initElements(driver, Repository_2.class);
        WebDriverWait wait = new WebDriverWait(driver, 10);
    ...
    public void click_the_order_by_option() throws InterruptedException {
        PageFactory.initElements(driver, Repository_2.class);
        WebDriverWait wait = new WebDriverWait(driver, 10);
